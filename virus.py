...
COVID19_PARAMS = {
    "r0": 2.28,  # rata2 kasus
    "incubation": 2,  # masa inkubasi
    "percent_mild": 0.1,  # kasus ringan
    "mild_recovery": (40, 50),  # rentang pemulihan
    "percent_severe": 0.9,  # kasus parah
    "severe_recovery": (40, 50),  # rentang pemulihan
    "severe_death": (1, 2),  # rentang kematian
    "fatality_rate": 0.090,  # persentase kematian
    "serial_interval": 3  # interval infeksi hari
}
...
class Virus():
    ...
    def spread_virus(self, i):  # time series
        ...
        self.day += 1  # time series

        self.update_status()
        self.update_text()

    def one_by_one(self, i, thetas, rs, color):  # sweep frame
    ...
    def assign_symptoms(self):  # sweep series
